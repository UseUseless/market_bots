...
from app.core.event import MarketEvent, SignalEvent, OrderEvent, FillEvent, Event # Типы события для обмена в очереди
from app.utils.trade_recorder import log_trade
from app.strategies.base_strategy import BaseStrategy
from config import BACKTEST_CONFIG
from app.core.sizer import BasePositionSizer, FixedRiskSizer
from app.core.risk_manager import AVAILABLE_RISK_MANAGERS, BaseRiskManager
