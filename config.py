...
RISK_CONFIG = {
    ...
    "ATR_MULTIPLIER_SL": 2.0,   # Множитель для стоп-лосса. SL = цена_входа - (ATR * этот_множитель).
                                # Чем больше значение, тем дальше (безопаснее, но и дороже) стоп.
    "ATR_MULTIPLIER_TP": 4.0,   # Множитель для тейк-профита. TP = цена_входа + (ATR * этот_множитель).
